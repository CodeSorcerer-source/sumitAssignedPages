      ...
      Array.from(document.querySelectorAll("[data-bs-open-on-hover]")).forEach(
        (e) => {
          ...
          e.addEventListener("mouseenter", () => {
            ...
            Array.from([i._menu, e]).forEach((e) =>
...
function mergeDeep(e, ...t) {
  ...
  if (isObject(e) && isObject(i))
    for (const t in i)
      isObject(i[t])
        ? (e[t] || Object.assign(e, { [t]: {} }), mergeDeep(e[t], i[t]))
...
//                       (this.control.clientHeight + e.clientHeight + 10) +
//                       "px"),
//                     (e.style.opacity = 0),
//                     setTimeout(() => {
...
//                     t.bottom > window.innerHeight
//                       ? (e.$menu.style.top =
//                           parseInt(e.$menu.style.top) -
//                           (e.control.clientHeight + e.$menu.clientHeight + 10) +
//                           "px")
//                       : t.top < 0 &&
//                         (e.$menu.style.top = `${
//                           parseInt(e.$menu.style.top) +
...
//           i.singleMultiple &&
//             e.singleMultiple(e.collection[t].$initializedEl, i),
//           i.hidePlaceholderOnSearch &&
//             e.hidePlaceholderOnSearch(e.collection[t].$initializedEl, i),
//           i.create && e.openIfEmpty(e.collection[t].$initializedEl, i),
//           i.hideSelectedFromField &&
//             e.hideSelectedFromField(e.collection[t].$initializedEl, i),
...
//       const i = (
//           e.control_input.getAttribute("placeholder") || t.placeholder
//         ).replace(/(<([^>]+)>)/gi, ""),
//         l = (t) => {
//           t.target.closest("[data-selectable].selected") &&
...
//       e.items.length &&
//         (t.searchInDropdown
//           ? o(e.items.length ? `${e.items.length} item(s) selected` : i)
//           : e.control_input.setAttribute(
//               "placeholder",
//               `${e.items.length} item(s) selected`
//             )),
...
//           e.items.length &&
//             (t.searchInDropdown
//               ? o(`${e.items.length} item(s) selected`)
//               : e.control_input.setAttribute(
//                   "placeholder",
//                   `${e.items.length} item(s) selected`
//                 ));
...
//             )
//               return (
//                 t.parentElement && t.parentElement.removeChild(t), (t = null)
//               );
//             e.items.length || t || o();
//           },
//           o = function () {
...
//                   e.items.length &&
//                     (() => {
//                       const t = e.wrapper.querySelector(
...
//             e.resultMinTargetEl(e.collection[t].$initializedEl, i),
//           i.result_max_target_el &&
//             e.resultMaxTargetEl(e.collection[t].$initializedEl, i));
//       }
//     },
...
//           (n.style.marginLeft =
//             (-e.parentElement.clientWidth / 100) * i + "px");
//       }
//     },
...
//       document
//         .querySelector(t.result_min_target_el)
...
//       e.querySelectorAll(
//         '[class="' + (t.textClass || i._textClass) + '"]'
//       ).forEach((e) => {
...
//                     o.secondaryText +
//                     "</div>"
//                   : (o.additionalText || "") + (o.isHideValue ? "" : e)
//                 : o.secondaryText
//                 ? (o.isHideValue ? "" : e) +
//                   (o.additionalText || "") +
//                   '<div style="margin-top: ' +
...
//                   o.secondaryText +
//                   "</div>"
//                 : (o.isHideValue ? "" : e) + (o.additionalText || "");
//             },
//           },
//           o
//         ),
...
//           i.rtl && e.setRtl(l, i),
//           i.fgStrokeLinecap &&
//             e.setStrokeLineCap(l, i, e.collection[t].$initializedEl),
//           i.fgStrokeMiterlimit &&
//             e.setStrokeMiterLimit(l, i, e.collection[t].$initializedEl),
//           i.isViewportInit &&
//             e.initAppear(l, i, e.collection[t].$initializedEl));
//       }
//     },
//   }),
...
//         if (
//           (l.setView(this.settings.map.coords, this.settings.map.zoom),
...
//             let e = L.marker(
//               this.settings.marker[o].coords,
//               this.settings.marker[o]
//             ).addTo(l);
//             this.settings.marker[o].popup &&
//               e.bindPopup(this.settings.marker[o].popup.text);
//           }
//         return l;
//       }
//     },
